  ...
  return (
    <>
      <div className="w-full max-w-6xl flex flex-col gap-10 px-2 mx-auto pt-5 pb-10">
        <div className="">
          <h1 className="font-medium mb-3">Create an Interview</h1>
          <div className="flex gap-10 flex-wrap">
            <Link
              href="/interview/ai-interview"
            ...
            >
              ...
              />
              <p>Anibot Interview</p>
            </Link>
            <Link
              href="/interview/professional"
              className="w-[300px] flex flex-col items-center gap-2 text-white rounded-3xl shadow-xl bg-blue-500 py-14 text-center hover:bg-blue-600 hover:scale-[1.03] transition-all ease-in"
            >
              <img
        ...
        <div>
          <h1 className="font-medium mb-3">Past Interviews</h1>
            ...
            {interviews && interviews.length > 0 ? (
              interviews.map((interview, index) => (
                ...
                >
                  ...
                  />
                  <p>
                    {`My Interview - ${index + 1}`}
                    <br />
                    {`Submitted: ${formatDateTime(new Date(interview.submissionTime))}`}
                  </p>
                </div>
              ))
            ) : (
        ...
        <div>
          <h1 className="font-medium mb-3">Assigned Interviews</h1>
          <div className="w-full flex gap-10 flex-wrap">
            {assignedInterviews &&
            assignedInterviews.assigned &&
            assignedInterviews.assigned.length > 0 ? (
              assignedInterviews.assigned.map((interview, index) => (
                ...
                >
                  ...
                  <p>
                    ...
                    <br />
                    {`Deadline: ${deadlineFormat(new Date(new Date(assignedInterviews.assignedTime[index]).getTime() + 2 * 24 * 60 * 60 * 1000))}`}
                  </p>
                </div>
              ))
            ) : (
            ...
            {isAssigned ? (
              <div className="flex flex-col gap-5 items-center">
                <p className="font-semibold">
                  Q: {interviewDetails.peerVideo.question.question}
                </p>
                <video
              ...
              <div className="flex flex-col gap-5 items-center">
                {typeof interviewDetails.reviews === "string" && (
                  <h2 className="font-medium">Feedback isn't given yet!</h2>
                )}
                <p className="font-semibold">
                  Q: {interviewDetails.question.question}
                </p>
                <video
                  ...
                  className="w-full h-auto"
                />
                {Array.isArray(interviewDetails.reviews) &&
                  interviewDetails.reviews.map((review, index) => (
                    <div
